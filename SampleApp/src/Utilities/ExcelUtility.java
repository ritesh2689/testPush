...
public class ExcelUtility {
	...
	public void fetchTestCaseData(int rowNumber) throws Exception {
		...
		rowData = Utility.getOdsSheetData(GlobalVar.TestexcelPath, Server,
				rowNumber);
	 ...
	 * HashMap<String, String> rowData = new HashMap<String, String>(); Workbook
	 * workbook = openWorkbook(GlobalVar.TestexcelPath); Sheet sheet =
	 * getSheetHandel(workbook, 2); rowData = fetchRowData(sheet, rowNumber);
	 * closeWorkbook(workbook); GlobalVar.TransactionData = rowData; }
	 */
