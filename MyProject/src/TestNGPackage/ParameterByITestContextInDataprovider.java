...
public class ParameterByITestContextInDataprovider {
	...
	public void testMethodB(String searchKey) throws InterruptedException {
		...
		// search a value on it
		searchText.sendKeys(searchKey);
		System.out.println("Welcome ->Unknown user Your search key is->"
				+ searchKey);
		Thread.sleep(3000);
		String testValue = searchText.getAttribute("value");
		System.out.println(testValue + "::::" + searchKey);
	...
	public Object[][] getDataFromDataprovider(ITestContext c) {
		...
		for (String group : c.getIncludedGroups()) {
			if (group.equalsIgnoreCase("A")) {
				groupArray = new Object[][] { { "Guru99", "India" },
						{ "Krishna", "UK" }, { "Bhupesh", "USA" } };
				break;
			} else if (group.equalsIgnoreCase("B")) {
				groupArray = new Object[][] { { "Canada" }, { "Russia" },
						{ "Japan" } };
				break;
			}
		}
		{
			groupArray = new Object[][] { { "fallbackAuthorName",
					"fallbackSearchString" } };
		}
